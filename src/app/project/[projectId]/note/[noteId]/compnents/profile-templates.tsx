          ...
          <div className="flex-1 sm:mb-2">
            ...
            <div className="mt-3 grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
              <div>
                ...
                <p className="font-medium text-gray-900">347세</p>
              </div>
              <div>
                <span className="text-gray-500">출신지</span>
                <p className="font-medium text-gray-900">실바니아</p>
              </div>
              <div>
                <span className="text-gray-500">직업</span>
                <p className="font-medium text-gray-900">대마법사</p>
              </div>
              <div>
                <span className="text-gray-500">소속</span>
                <p className="font-medium text-gray-900">마법 의회</p>
              </div>
            </div>
          </div>
        </div>
